...
if __name__ == '__main__':
    ...
    # Time how long it takes just to create the comm object
    ...
    chunk_params = np.array_split(cov_params * reps, numproc)
    print(numproc)
#    betas[rep, :] = beta.ravel()
    ...
    # pre-generated
    for i, cov_param in enumerate(chunk_params[rank]):
